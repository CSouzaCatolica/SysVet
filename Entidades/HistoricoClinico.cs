public class HistoricoClinico
{
    ...
    public HistoricoClinico(int id, int idDoProntuario, int idDoAgendamento, int idDoVeterinario, DateTime dataAtendimento, string diagnostico, string tratamento, string observacoes)
    {
        this.id = id;
